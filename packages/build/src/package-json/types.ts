...
export const PackageJsonSchema: ZodObject = zod
    .looseObject({
        name: zod.string(),
        ...
        homepage: zod.string(),
        repository: zod
            .union([zod.string(), zod.object({ type: zod.string(), url: zod.string() })])
            .transform(val => {
        ...
        catalogs: zod.record(zod.string(), zod.record(zod.string(), zod.string())),
        ...
        bundledDependencies: zod.array(zod.string()),
